...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/click-meter/apis.md
specificationVersion: "0.14"
apis:
- name: Click Meter - Fast patch the "notes" field of a conversion
  x-api-slug: conversionsconversionidnotes-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/click-meter/conversionsconversionidnotes-put-openapi.md
- name: Click Meter - Fast patch the "notes" field of a datapoint
  x-api-slug: datapointsidnotes-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/click-meter/datapointsidnotes-put-openapi.md
- name: Click Meter - Fast patch the "notes" field of a group
  x-api-slug: groupsidnotes-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/click-meter/groupsidnotes-put-openapi.md
x-common:
- type: x-api-gallery
