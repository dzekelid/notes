...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/google-doubleclick/apis.md
...
- name: Google Doubleclick Merged API - Get Proposal Notes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/google-doubleclick/proposalsproposalidnotes-get-openapi.md
- name: Google Doubleclick Merged API - Insert Proposal Notes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/google-doubleclick/proposalsproposalidnotesinsert-post-openapi.md
- name: Google Doubleclick Merged API - Get Proposal Notes
  x-api-slug: proposalsproposalidnotes-get
  description: Get all the notes associated with a proposal
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-double-click.png
