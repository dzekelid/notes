...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/apis.md
...
- name: IDX API 1.4.0 Test Runner - Put Leads Note
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadid-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadid-put-openapi.md
- name: IDX API 1.4.0 Test Runner - Post Leads Note
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadidnoteid-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadidnoteid-post-openapi.md
- name: IDX API 1.4.0 Test Runner - Delete Leads Note
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadidnoteid-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/notes/master/_listings/idx-broker/leadsnoteleadidnoteid-delete-openapi.md
- name: IDX API 1.4.0 Test Runner - Put Leads Note
  x-api-slug: leadsnoteleadid-put
  description: Add new note information for a lead.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/idx-broker.png
